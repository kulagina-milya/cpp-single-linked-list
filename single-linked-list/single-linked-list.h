...
public:
    ...
    SingleLinkedList(const SingleLinkedList& other) {
        ...
        Node* last = nullptr;
        for (Node* i = other.head_.next_node; i != nullptr; i = i->next_node)
        {
            Node* item = new Node(i->value, nullptr);
            if (!tmp.head_.next_node) {
                tmp.head_.next_node = item;
            }
            else {
                last->next_node = item;
            }
    ...
    Iterator InsertAfter(ConstIterator pos, const Type& value) {
        ...
        Node* ptr = new Node(value, pos.node_->next_node);
    ...
    void PopFront() noexcept {
        ...
        auto second = head_.next_node->next_node;
    ...
    Iterator EraseAfter(ConstIterator pos) noexcept {
        ...
        auto next = erase_node->next_node;
        delete erase_node;
